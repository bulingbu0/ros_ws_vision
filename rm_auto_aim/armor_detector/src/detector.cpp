...
ArmorType Detector::isArmor(const Light & light_1, const Light & light_2)
{
  ...
  bool analogy_angle = abs(light_1.tilt_angle - light_2.tilt_angle) < 10;
  // std::cout << light_ratio_ok << " center_distance_ok: " << center_distance_ok << " angle_ok: " << angle_ok << std::endl;
  bool is_armor = light_ratio_ok && center_distance_ok && angle_ok && analogy_angle;
